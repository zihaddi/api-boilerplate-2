...
class DonationAllocationStoreRequest extends FormRequest
{
    use HttpResponses;
    ...
    public function rules(): array
    {
        return [
            ...
            'allocated_to_id' => 'required|integer|exists:users,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'allocated_to_id.required' => 'Allocation recipient is required.',
            'allocated_to_id.exists' => 'Selected recipient does not exist.',
            'amount_allocated.required' => 'Allocation amount is required.',
